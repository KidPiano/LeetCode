...
Below, I have highlighted the changes we need to make to DFS to determine if a graph is acyclic:<div style="display:inline-block; text-align:left">
<span>ooga booga</span>
<h4>DFS (original)</h4>
