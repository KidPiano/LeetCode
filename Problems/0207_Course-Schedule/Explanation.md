...
<h4>DFS (original)</h4>
<pre style="font-size:xx-small"><code>void DFS() {
...
<div style="display:inline-block; text-align:left">
<h4>DFS (modified)</h4>
<pre style="font-size:xx-small"><code>// now returns true if the graph is acyclic, false otherwise
...
<div style="display:inline-block; text-align:left">
<h4>DFS (modified)</h4>
<pre style="font-size:60%"><code>// now returns true if the graph is acyclic, false otherwise
<span style="background-color:orange">boolean</span> DFS() {
    for (int u = 0; u < numVertices; u++)
        if (color[u] == 'w')
            <span style="background-color:orange">if (visit(u)) return false;</span>
